...
@Log4j2
public class AsociacionNoMovilController extends AbstractPanelFactory{
  ...
  @FXML 
  private SButton btnCancelar, btnSalir;
  @FXML
  ...
  public void initialize(URL location, ResourceBundle resources) {
    ...
    tblConsulta.addColumnTextField("cta", resources.getString("ascnomovilcap.colProducto"), 100, AlingEnum.LEFT, AlingEnum.RIGHT, Formato.JUST_NUMBER, false);
    tblConsulta.addColumnTextField("cta", resources.getString("ascnomovilcap.colCuenta"), 100, AlingEnum.LEFT, AlingEnum.RIGHT, Formato.JUST_NUMBER, false);
    ...
    tblConsulta.addColumnTextField("cta", resources.getString("ascnomovilcap.colNumMovil"), 100, AlingEnum.LEFT, AlingEnum.RIGHT, Formato.JUST_NUMBER, false);
    tblConsulta.addColumnTextField("cta", resources.getString("ascnomovilcap.colFechaAlta"), 200, AlingEnum.LEFT, AlingEnum.RIGHT, Formato.JUST_NUMBER, false);
